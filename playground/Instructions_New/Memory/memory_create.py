...
dirs = os.listdir('./playground/Instructions_New')
...
for number in number_of_memory:
    for stage in range(1,len(Stage_list)):
        ...
        json.dump(memory_datas,open('./playground/Instructions_New/Memory/{}_memory_{}.json'.format(Stage_list[stage],number),'w'),indent=4)