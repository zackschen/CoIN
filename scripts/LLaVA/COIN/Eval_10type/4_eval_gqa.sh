...
RESULT_DIR="./results/CoIN/LLaVA-10Typev2/GQA"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m ETrain.Eval.LLaVA.CoIN.model_gqa \
        ...
        --question-file ./playground/Instructions_10type_slim/GQA/test.json \
...
python -m ETrain.Eval.LLaVA.CoIN.create_prompt \
    ...
    --questions ./playground/Instructions_10type_slim/GQA/test.json \
    --results $output_file \