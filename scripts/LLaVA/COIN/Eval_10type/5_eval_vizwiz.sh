...
RESULT_DIR="./results/CoIN/LLaVA-10Typev2/VizWiz"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m ETrain.Eval.LLaVA.CoIN.model_vizwiz \
        ...
        --question-file ./playground/Instructions_10type_slim/VizWiz/val.json \
...
python -m ETrain.Eval.LLaVA.CoIN.eval_vizwiz \
    ...
    --annotation-file ./playground/Instructions_10type_slim/VizWiz/val.json \
    --output-dir $RESULT_DIR/$STAGE \

python -m ETrain.Eval.LLaVA.CoIN.create_prompt \
    --rule ./ETrain/Eval/LLaVA/CoIN/rule.json \
    --questions ./playground/Instructions_10type_slim/VizWiz/val.json \
    --results $output_file \