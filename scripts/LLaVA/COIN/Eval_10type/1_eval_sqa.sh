...
RESULT_DIR="./results/CoIN/LLaVA-10Typev2/ScienceQA"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m ETrain.Eval.LLaVA.CoIN.model_vqa_science \
        ...
        --question-file ./playground/Instructions_10type_slim/ScienceQA/test.json \
...
python -m ETrain.Eval.LLaVA.CoIN.create_prompt \
    ...
    --questions ./playground/Instructions_10type_slim/ScienceQA/test.json \
    --results $output_file \