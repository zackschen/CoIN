...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --previous_task_model_path ./checkpoints/LLaVA/Instruction/CoIN-13b/VizWiz_llava_lora \
    --version $PROMPT_VERSION \
    --data_path ./playground/Instructions_Type1/Grounding/train.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/Instruction/CoIN-13b/Grounding_llava_lora \
    --num_train_epochs 1 \
