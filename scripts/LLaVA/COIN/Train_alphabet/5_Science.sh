################## VICUNA ##################
PROMPT_VERSION=v1
MODEL_VERSION="vicuna-alphabet-v1.5"
################## VICUNA ##################
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 ETrain/Train/LLaVA/train_mem.py \
    ...
    --previous_task_model_path ./checkpoints/LLaVA/Instruction/CoIN-alphabet/Grounding \
    ...
    --bf16 True \
    --output_dir ./checkpoints/LLaVA/Instruction/CoIN-alphabet/ScienceQA \
    --num_train_epochs 1 \
