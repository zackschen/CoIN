...
deepspeed --include localhost:0,1,2,3,4,5,6 --master_port 29600 ETrain/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./checkpoints/Instruction/Only_Pretrain_1.5/ScienceQA/llava-1.5-7b-lora \
    --num_train_epochs 1 \
