...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/1_eval_sqa.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/ScienceQA/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/2_eval_textqa.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/TextVQA/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/3_eval_ImageNet.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/ImageNet/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/4_eval_gqa.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/GQA/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/5_eval_vizwiz.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/VizWiz/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/6_eval_visualgenome.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/Grounding/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/7_eval_vqav2.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/VQAv2/llava-1.5-7b-lora
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 bash ./scripts/Instruction_CC/LoRA/Eval/8_eval_ocrvqa.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5/OCRVQA/llava-1.5-7b-lora
