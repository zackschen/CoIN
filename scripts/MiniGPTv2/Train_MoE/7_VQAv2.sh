CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 HF_ENDPOINT="https://hf-mirror.com" OMP_NUM_THREADS=1 NCCL_P2P_DISABLE=1 torchrun --nproc_per_node 8 \
    ...
    --cfg-path ./scripts/MiniGPTv2/Train/7_VQAv2.yaml \
    --bf16 True \
    --previous_task_model_path ./checkpoints/MiniGPTv2/CoIN_MoE/Grounding \
    --output_dir ./checkpoints/MiniGPTv2/CoIN_MoE/VQAv2 \
    --num_train_epochs 1 \
