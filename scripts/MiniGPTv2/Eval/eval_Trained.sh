...
bash ./scripts/MiniGPTv2/Eval/2_TextVQA.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/3_ImageNet.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/4_GQA.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/5_VizWiz.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/6_Grounding.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/7_VQAv2.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
bash ./scripts/MiniGPTv2/Eval/8_OCRVQA.sh Multitask ./checkpoints/MiniGPTv2/CoIN/Finetune/Multitask
