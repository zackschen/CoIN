...
def parse_args():
    ...
    parser.add_argument('--dir', type=str, default="./results/Instructions/VQAv2/Zero_shot")
...
if __name__ == '__main__':
    ...
    test_split = '/home/chencheng/Code/LLaVA/playground/Instructions/VQAv2/test.json'
