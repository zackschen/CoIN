...
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 29600 llava/train/train_mem_MOE.py \
    ...
    --previous_task_model_path ./checkpoints/Instruction/Only_Pretrain_1.5_MOE_2/Grounding/llava-1.5-7b-lora \
    ...
    --bf16 True \
    --output_dir ./checkpoints/Instruction/Only_Pretrain_1.5_MOE_2/VQAv2/llava-1.5-7b-lora \
    --num_train_epochs 1 \
