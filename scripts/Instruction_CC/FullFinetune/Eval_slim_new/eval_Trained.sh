...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/6_eval_visualgenome.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/1_eval_sqa.sh Grounding ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/2_eval_textqa.sh Grounding ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/3_eval_ImageNet.sh Grounding ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/4_eval_gqa.sh Grounding ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/FullFinetune/Eval_slim_new/5_eval_vizwiz.sh Grounding ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Grounding/llava-1.5-7b-lora
