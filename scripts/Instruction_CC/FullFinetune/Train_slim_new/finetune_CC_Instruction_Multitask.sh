...
deepspeed --include localhost:0,1,2,3,4,5,6 --master_port 29600 llava/train/train_mem.py \
    ...
    --data_path ./playground/Instructions_slim/Multitask/train_new.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/Instruction/Only_Pretrain_1.5_slim_new_full/Multitask/llava-1.5-7b-lora \
    --num_train_epochs 1 \
