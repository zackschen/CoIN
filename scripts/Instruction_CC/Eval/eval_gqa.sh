...
STAGE='Finetune'
RESULT_DIR="./results/Instructions/Only_Pretrain/1.5/GQA"

for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.Instruction_CC.model_gqa \
        --model-path ./checkpoints/Instruction/Only_Pretrain_1.5/GQA/llava-1.5-7b-lora \
...
python llava/eval/Instruction_CC/eval_gqa.py --tier testdev_balanced --path $RESULT_DIR/$STAGE
