...
RESULT_DIR="./results/CLIT/OCRVQA"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.Instruction_CC.model_ocr_vqa \
        ...
        --question-file ./playground/Instructions/OCRVQA/val.json \
...
python -m llava.eval.Instruction_CC.eval_ocrvqa \
    --annotation-file /home/chencheng/Code/LLaVA/playground/Instructions/OCRVQA/test.json \
