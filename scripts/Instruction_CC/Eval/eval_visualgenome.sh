...
STAGE='Zero_shot'
RESULT_DIR="./results/Instructions/Only_Pretrain/1.5/VisualGenome"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.Instruction_CC.model_vqa_cc_instruction \
        ...
        --question-file ./playground/Instructions/VisualGenome/test.json \
...
python -m llava.eval.Instruction_CC.eval_grounding \
    --test-file ./playground/Instructions/VisualGenome/test.json \
