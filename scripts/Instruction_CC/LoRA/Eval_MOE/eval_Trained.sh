...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/6_eval_visualgenome.sh Finetune ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/1_eval_sqa.sh VisualGenome ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/2_eval_textqa.sh VisualGenome ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/3_eval_ImageNet.sh VisualGenome ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/4_eval_gqa.sh VisualGenome ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash /home/chencheng/Code/LLaVA/scripts/Instruction_CC/LoRA/Eval_MOE/5_eval_vizwiz.sh VisualGenome ./checkpoints/Instruction/Only_Pretrain_1.5_MOE/VisualGenome/llava-1.5-7b-lora
