...
OUTPUT_MODEL_PATH="./checkpoints/Qwen/CoIN_MoE/VizWiz"
DATA="playground/Instructions_Qwen/VizWiz/train_new.json"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun $DISTRIBUTED_ARGS ETrain/Train/Qwen/train.py \
    ...
    --previous_task_model_path ./checkpoints/Qwen/CoIN_MoE/GQA \
    --num_train_epochs 1 \
