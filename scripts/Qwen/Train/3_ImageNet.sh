...
OUTPUT_MODEL_PATH="./checkpoints/Qwen/CoIN_MoE/ImageNet"
DATA="playground/Instructions_Qwen/ImageNet/train_new.json"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun $DISTRIBUTED_ARGS ETrain/Train/Qwen/train.py \
    ...
    --previous_task_model_path ./checkpoints/Qwen/CoIN_MoE/TextVQA \
    --num_train_epochs 1 \
