...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/Qwen/Eval_MoE/6_eval_visualgenome.sh VQAv2 ./checkpoints/Qwen/CoIN_MoE/VQAv2
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 bash ./scripts/Qwen/Eval_MoE/6_eval_visualgenome.sh OCRVQA ./checkpoints/Qwen/CoIN_MoE/OCRVQA
