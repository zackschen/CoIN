...
OUTPUT_MODEL_PATH="./checkpoints/Qwen/CoIN_Chat_MoE/Grounding"
PREVIOUS_MODEL_PATH="./checkpoints/Qwen/CoIN_Chat_MoE/VizWiz"
DATA="playground/Instructions_Qwen/Grounding/train.json"
