...
OUTPUT_MODEL_PATH="./checkpoints/Qwen/CoIN_Chat_MoE/OCRVQA"
PREVIOUS_MODEL_PATH="./checkpoints/Qwen/CoIN_Chat_MoE/VQAv2"
DATA="playground/Instructions_Qwen/OCRVQA/train.json"
