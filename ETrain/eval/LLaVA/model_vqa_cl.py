...
def eval_model(args):
    ...
    model = LlavaLlamaForCausalLM.from_pretrained(model_path, low_cpu_mem_usage=True, config=cfg_pretrained)

    mm_projector_weights = torch.load(os.path.join(args.pretrain_mm_mlp_adapter, 'mm_projector.bin'), map_location='cpu')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrain_mm_mlp_adapter", type=str, default="./checkpoints/LLaVA-v1.5-7b")
